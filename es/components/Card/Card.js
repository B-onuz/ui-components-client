...
var _this = void 0,
  _jsxFileName = '/home/junior/Fontes/ui-components-client/src/components/Card/Card.js'
...
var StyledCard = _styledComponents['default'].div(
  _templateObject(),
  function (_ref) {
...
var StyledTitle = _styledComponents['default'].span(
  _templateObject2(),
  function (_ref10) {
...
var StyledIcon = _styledComponents['default'].img(
  _templateObject5(),
  function (_ref14) {
...
var StyledHelper = _styledComponents['default'].small(
  _templateObject6(),
  function (_ref16) {
...
var ClickableCard = _styledComponents['default'].button(
  _templateObject7(),
  function (_ref18) {
...
var Card = function Card(_ref21) {
  var title = _ref21.title,
    ...
    rest = _objectWithoutPropertiesLoose(_ref21, [
      'title',
      'count',
      'icon',
      'customIcon',
