...
var _this = void 0,
  _jsxFileName = '/home/junior/Fontes/ui-components-client/src/components/Textarea/Textarea.js'
...
var StyledTextarea = _styledComponents['default'].textarea(
  _templateObject(),
  function (_ref) {
  ...
  function (_ref3) {
    ...
    return (
      !!error &&
      '\n      box-shadow: 0 0 3px ' +
        new _color['default'](theme.colors['red']).fade(0.5).string() +
        ';\n      border: 1px solid ' +
        theme.colors['red'] +
        ';\n    '
    )
