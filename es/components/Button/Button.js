...
var _this = void 0,
  _jsxFileName = '/home/junior/Fontes/ui-components-client/src/components/Button/Button.js'
  ...
  function (_ref6) {
    ...
    return (
      ...
      '\n    background-color: #fff;\n    color: ' +
        ...
        theme.colors[color] +
        ';\n      color: ' +
        (new _color['default'](theme.colors[color]).isDark() ? '#fff' : '#000') +
        ' !important;\n    }\n    '
    )
  },
  function (_ref7) {
...
var Button = function Button(_ref17) {
  var children = _ref17.children,
    ...
    rest = _objectWithoutPropertiesLoose(_ref17, [
      'children',
      'loading',
      'disabled',
      'icon',
